...
const menu = [['Search','/search'],['Compare','/compare'],['Leaderboard','/leaderboard'],['Submit','/submit'],['List%','/list-percent'],['News','/announcements'],['Rules','/rules'],['Time Machine','/time-machine'],['Changelog','/changelog'],['Report','/report'],['Legacy','/legacy'],['Admin','/admin']];
